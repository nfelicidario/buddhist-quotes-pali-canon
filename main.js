...
function setRandomBackgroundImage() {
  ...
  .then(backgroundData => {
    ...
    document.getElementById("attribution").innerHTML = `Photo by <a href='${background.photographer_url}?utm_source=buddhist_quotes&utm_medium=referral'> ${background.photographer}</a> on <a href='https://unsplash.com/?utm_source=buddhist_quotes&utm_medium=referral'>Unsplash</a>`
  })
}
